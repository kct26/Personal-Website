export default function CircuitCover() {
  return (
    <svg viewBox="0 0 300 160" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="53" y="46" fill="var(--glow)" fontFamily="IBM Plex Mono" fontSize="10" textAnchor="middle">REG</text>

      <rect x="18" y="98" width="70" height="40" rx="3" stroke="var(--ink-text-dim)" strokeWidth="1.4" />
      <text x="53" y="122" fill="var(--ink-text-dim)" fontFamily="IBM Plex Mono" fontSize="10" textAnchor="middle">CTRL</text>

      <rect x="118" y="60" width="70" height="40" rx="3" stroke="var(--glow-signal)" strokeWidth="1.4" />
      <text x="153" y="84" fill="var(--glow-signal)" fontFamily="IBM Plex Mono" fontSize="10" textAnchor="middle">ALU</text>

      <rect x="218" y="22" width="64" height="40" rx="3" stroke="var(--glow)" strokeWidth="1.4" />
      <text x="250" y="46" fill="var(--glow)" fontFamily="IBM Plex Mono" fontSize="10" textAnchor="middle">OUT</text>
